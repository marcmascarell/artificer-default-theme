...
<!--	<script src="{{ asset('packages/mascame/artificer-default-theme/js/plugins/morris/morris.min.js') }}" type="text/javascript"></script>-->
<!-- Sparkline -->
<script src="{{ asset('packages/mascame/artificer-default-theme/js/plugins/sparkline/jquery.sparkline.min.js') }}" type="text/javascript"></script>
<!-- jvectormap -->
<script src="{{ asset('packages/mascame/artificer-default-theme/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js') }}" type="text/javascript"></script>
<script src="{{ asset('packages/mascame/artificer-default-theme/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js') }}" type="text/javascript"></script>
<!-- jQuery Knob Chart -->
<script src="{{ asset('packages/mascame/artificer-default-theme/js/plugins/jqueryKnob/jquery.knob.js') }}" type="text/javascript"></script>
<!-- daterangepicker -->
...
<!-- <script src="{{ asset('packages/mascame/artificer-default-theme/js/AdminLTE/demo.js') }}" type="text/javascript"></script>-->
